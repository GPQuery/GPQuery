...
describe('Race API:', function() {
  ...
  describe('PUT /api/races/:id', function() {
    ...
    it('should respond with the updated race', function() {
      expect(updatedRace.name).to.equal('Updated Race');
      expect(updatedRace.info).to.equal('This is the updated race!!!');
    });
