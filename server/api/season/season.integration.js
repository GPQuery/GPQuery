...
describe('Season API:', function() {
  describe('GET /api/seasons', function() {
    ...
    it('should respond with JSON array', function() {
      expect(seasons).to.be.instanceOf(Array);
    });
  });
  ...
  describe('POST /api/seasons', function() {
    ...
    it('should respond with the newly created season', function() {
      expect(newSeason.name).to.equal('New Season');
      expect(newSeason.info).to.equal('This is the brand new season!!!');
    });
  });
  ...
  describe('GET /api/seasons/:id', function() {
    ...
    it('should respond with the requested season', function() {
      expect(season.name).to.equal('New Season');
      expect(season.info).to.equal('This is the brand new season!!!');
    });
  });
  ...
  describe('PUT /api/seasons/:id', function() {
    ...
    it('should respond with the updated season', function() {
      expect(updatedSeason.name).to.equal('Updated Season');
      expect(updatedSeason.info).to.equal('This is the updated season!!!');
    });
    ...
    it('should respond with the updated season on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(season.name).to.equal('Updated Season');
          expect(season.info).to.equal('This is the updated season!!!');
  ...
  describe('PATCH /api/seasons/:id', function() {
    ...
    it('should respond with the patched season', function() {
      expect(patchedSeason.name).to.equal('Patched Season');
      expect(patchedSeason.info).to.equal('This is the patched season!!!');
    });
  });
